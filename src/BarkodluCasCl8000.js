...
function BarkodluCasCl8000() {
  ...
  return (
    <>
        <Template></Template>
        <Typography style={{position:"absolute",top:610,left:680}} fontSize={30}>CL-8000</Typography>
    ...
    <Grid xs={1.5} style={{marginLeft:400,marginTop:100}}>
       ...
       <Typography style={{fontSize:"18px"}}>15" dokunmatik ekranlı yeni model CAS CL-8000, kullanışlı ve modern bir arayüze sahip süpermarketler için bir standart satış ve self servis modu bulunan terazi sistemidir.</Typography>
        ...
        <img style={{marginLeft:60,marginTop:30}} src={casCL8000} alt={"cl3000"}height={400} width={350}></img>
        ...
        <Grid xs={5} style={{border:"1px solid black",height:350,marginLeft:680,marginTop:40}}>
