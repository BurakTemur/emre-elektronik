...
import MavinNa2EkranGörüntüsü from './Images/Mavin NA2 Ekran Görüntüsü.png'

function LoadcellDensiMavinNA2() {
  ...
  return (
    <>
     <Template></Template>
     <Typography style={{position:"absolute",top:610,left:"36%"}} sx={{"&:hover":{color:"black"} , fontSize: "clamp(20px, 2.51vw, 30px)", whiteSpace:"nowrap"}}>Mavin NA2</Typography>
    ...
    <Grid sx={{marginLeft:"2%",marginTop:15}}>
            ...
            <Grid container alignItems="end" marginTop={2}>
                ...
                <Typography sx={{marginLeft:"10px"}} fontSize={"16px"}>60 - 100 - 150 - 200 - 250 - 300 - 350 - 500</Typography>
            </Grid>
            ...
            <img src={MavinNa2EkranGörüntüsü} height={400} alt={"Mavin NA1"} width={"100%"}></img>
...
export default LoadcellDensiMavinNA2