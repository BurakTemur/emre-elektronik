...
import MavinNa3EkranGörüntüsü from './Images/Mavin NA3 Ekran Görüntüsü.png'

function LoadcellDensiMavinNA3() {
  ...
  return (
    <>
     <Template></Template>
     <Typography style={{position:"absolute",top:610,left:"36%"}} sx={{"&:hover":{color:"black"} , fontSize: "clamp(20px, 2.51vw, 30px)", whiteSpace:"nowrap"}}>Mavin NA3</Typography>
    ...
    <Grid sx={{marginLeft:"2%",marginTop:15}}>
            <Typography fontSize={"20px"}>Single Point (Tek nokta) Platform Tipi - Alüminyum Load Cell</Typography>
            <Grid container alignItems="end" marginTop={2}>
                <Typography fontSize={"20px"} sx={{fontWeight:"bold"}}>Kapasite(kg) :</Typography>
                <Typography sx={{marginLeft:"10px"}} fontSize={"16px"}>50 - 60 - 100 - 150 - 200 - 250 - 300 - 500 - 600 - 750 - 800 - 1000 - 1200 </Typography>
            </Grid>
            ...
            <img src={MavinNa3EkranGörüntüsü} height={400} alt={"Mavin NA1"} width={"100%"}></img>
...
export default LoadcellDensiMavinNA3