...
function LoadcellDensiTEDEA1510() {
  ...
  return (
    <>
     <Template></Template>
     <Typography style={{position:"absolute",top:610,left:"36%"}} sx={{"&:hover":{color:"black"} , fontSize: "clamp(20px, 2.51vw, 30px)", whiteSpace:"nowrap"}}>TEDEA 1510</Typography>
    ...
    <Grid sx={{marginLeft:"2%",marginTop:15}}>
            <Typography fontSize={"20px"}>TEDEA - Lama Tipi - Paslanmaz Çelik 500kg</Typography>
            <Grid container alignItems="end" marginTop={2}>
                <Typography fontSize={"20px"} sx={{fontWeight:"bold"}}>Model :</Typography>
                <Typography sx={{marginLeft:"10px"}} fontSize={"16px"}>TEDEA 1510</Typography>
            </Grid>
            <Grid container alignItems="end" marginTop={2}>
                <Typography fontSize={"20px"} sx={{fontWeight:"bold"}}>Kullanım :</Typography>
                <Typography sx={{marginLeft:"10px", textAlign:"end"}} fontSize={"16px"}>Platform Tipi Tartım - IP 68</Typography>
            </Grid>
...
export default LoadcellDensiTEDEA1510