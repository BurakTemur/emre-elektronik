...
import MavinNS1EkranGörüntüsü from './Images/Mavin NS1 Ekran Görüntüsü.png'

function LoadcellDensiMavinNS1() {
  ...
  return (
    <>
     <Template></Template>
     <Typography style={{position:"absolute",top:610,left:"36%"}} sx={{"&:hover":{color:"black"} , fontSize: "clamp(20px, 2.51vw, 30px)", whiteSpace:"nowrap"}}>Mavin NS1 - NS2</Typography>
    ...
    <Grid sx={{marginLeft:"2%",marginTop:15}}>
            ...
            <Grid container alignItems="end" marginTop={2}>
                ...
                <Typography sx={{marginLeft:"10px"}} fontSize={"16px"}>100 - 200 - 250 - 300 - 350 - 500 - 750 </Typography>
            </Grid>
            <Grid container alignItems="end" marginTop={2} marginBottom={5}>
                <Typography fontSize={"20px"} sx={{fontWeight:"bold",marginLeft:10}}>(ton) :</Typography>
                <Typography sx={{marginLeft:"10px", textAlign:"end"}} fontSize={"16px"}>1 - 1,5 - 2 - 2,5 - 3 - 5  </Typography>
            </Grid>
             <Grid container alignItems="end" marginTop={2} marginBottom={5}>
            ...
            <img src={MavinNS1EkranGörüntüsü} height={400} alt={"Mavin NA1"} width={"100%"}></img>
...
export default LoadcellDensiMavinNS1