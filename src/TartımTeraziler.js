...
function TartımTeraziler() {
  ...
  return (
    <>
    <Template></Template>
    <Typography style={{position:"absolute",top:610,left:680}} fontSize={30}>Tartım Teraziler</Typography>
    ...
    <Grid xs={1.5} style={{marginLeft:400,marginTop:100}}>
      ...
      <Grid onClick={()=>navigate("/Tartım Hana")} onMouseEnter={()=> setHovered1(true)} onMouseLeave={()=>setHovered1(false)} bgcolor={"white"} container justifyContent={"center"}  xs={2} style={{height:400,marginTop:hovered1 ? 60:80,marginLeft:30,padding:30,position:"relative",border:"1px solid white", borderRadius:10,boxShadow: "2px 2px 10px rgba(0, 0, 0,0.3)", transition: "margin-top 0.5s ease"}}>
        <img src={hanaHS2000LCD} alt={"hana"}height={300} width={250}></img>
      ...
      <Grid onClick={()=>navigate("/Tartım Neck")}  onMouseEnter={()=>setHovered2(true)} onMouseLeave={()=>setHovered2(false)} bgcolor={"white"} container justifyContent={"center"}  xs={2} style={{height:400,marginLeft:50,marginTop:hovered2 ? 60:80,padding:30,position:"relative",border:"1px solid white", borderRadius:10,boxShadow: "2px 2px 10px rgba(0, 0, 0,0.3)",transition: "margin-top 0.5s ease"}} >
        <img src={neckJCSB} alt={"neck"} height={300} width={250}></img>
        <Typography style={{fontSize:20,fontWeight:'bold',textAlign:"center"}}>NECK</Typography>
      </Grid> 
      <Grid onClick={()=>navigate("/Tartım Cas")}  onMouseEnter={()=>setHovered3(true)} onMouseLeave={()=>setHovered3(false)} bgcolor={"white"} container justifyContent={"center"}  xs={2} style={{height:400,marginLeft:50,marginTop:hovered3 ? 60:80,padding:30,position:"relative",border:"1px solid white", borderRadius:10,boxShadow: "2px 2px 10px rgba(0, 0, 0,0.3)",transition: "margin-top 0.5s ease"}} >
        <img src={casSW2} alt={"cas"} height={300} width={250}></img>
        <Typography style={{fontSize:20,fontWeight:'bold',textAlign:"center"}}>CAS</Typography>
      </Grid>  
    </Grid>
    <Grid container xs={12}>

      <Grid onClick={()=>navigate("/Tartım Tem")}  onMouseEnter={()=>setHovered4(true)} onMouseLeave={()=>setHovered4(false)} bgcolor={"white"} container justifyContent={"center"}  xs={2} style={{height:400,marginLeft:665,marginTop:hovered4 ? 60:80,padding:30,position:"relative",border:"1px solid white", borderRadius:10,boxShadow: "2px 2px 10px rgba(0, 0, 0,0.3)",transition: "margin-top 0.5s ease"}} >
        <img src={temAtaTB} alt={"tem"} height={300} width={250}></img>
        <Typography style={{fontSize:20,fontWeight:'bold',textAlign:"center"}}>TEM</Typography>
      </Grid>
       <Grid onClick={()=>navigate("/Tartım Murbay")}  onMouseEnter={()=>setHovered5(true)} onMouseLeave={()=>setHovered5(false)} bgcolor={"white"} container justifyContent={"center"}  xs={2} style={{height:400,marginLeft:60,marginTop:hovered5 ? 60:80,padding:30,position:"relative",border:"1px solid white", borderRadius:10,boxShadow: "2px 2px 10px rgba(0, 0, 0,0.3)",transition: "margin-top 0.5s ease"}} >
        <img src={murbaySelesAgtSuKorumalı} alt={"murbay"} height={300} width={250}></img>
        <Typography style={{fontSize:20,fontWeight:'bold',textAlign:"center"}}>MURBAY</Typography>
      </Grid>  
        <Grid onClick={()=>navigate("/Tartım Dikomsan")}  onMouseEnter={()=>setHovered5(true)} onMouseLeave={()=>setHovered6(false)} bgcolor={"white"} container justifyContent={"center"}  xs={2} style={{height:400,marginLeft:60,marginTop:hovered6 ? 60:80,padding:30,position:"relative",border:"1px solid white", borderRadius:10,boxShadow: "2px 2px 10px rgba(0, 0, 0,0.3)",transition: "margin-top 0.5s ease"}} >
        <img src={dikomsanQWM} alt={"murbay"} height={300} width={250}></img>
