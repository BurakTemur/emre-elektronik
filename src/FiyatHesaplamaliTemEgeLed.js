...
function FiyatHesaplamaliTemEgeLed() {
    ...
    return (
      <>
          <Template></Template>
          <Typography style={{position:"absolute",top:610,left:680}} fontSize={30}>Ege Led</Typography>
      ...
      <img style={{marginLeft:60,marginTop:30}} src={temEgeLed} alt={"cl3000"}height={400} width={450}></img>
