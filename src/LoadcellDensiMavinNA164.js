...
import MavinNa164EkranGörüntüsü from './Images/Mavin NA116 Ekran Görüntüsü.png'

function LoadcellDensiMavinNA164() {
  ...
  return (
    <>
     <Template></Template>
     <Typography style={{position:"absolute",top:610,left:"36%"}} sx={{"&:hover":{color:"black"} , fontSize: "clamp(20px, 2.51vw, 30px)", whiteSpace:"nowrap"}}>Mavin NA164</Typography>
    ...
    <Grid sx={{marginLeft:"2%",marginTop:15}}>
            ...
            <Grid container alignItems="end" marginTop={2}>
                ...
                <Typography sx={{marginLeft:"10px"}} fontSize={"16px"}>500 - 750 - 800</Typography>
            </Grid>
            ...
            <img src={MavinNa164EkranGörüntüsü} height={400} alt={"Mavin NA1"} width={"100%"}></img>
...
export default LoadcellDensiMavinNA164