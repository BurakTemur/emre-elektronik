...
function FiyatHesaplamaliDensiPc100() {
    ...
    return (
      <>
          <Template></Template>
          <Typography style={{position:"absolute",top:610,left:680}} fontSize={30}>PC-100</Typography>
      ...
      <Grid xs={1.5} style={{marginLeft:400,marginTop:100}}>
         ...
         <img style={{marginLeft:80,marginTop:30}} src={densiPC100} alt={"cl3000"}height={400} width={450}></img> 
      </Grid>

      <Grid container>
        <Typography style={{fontWeight:"bold", fontSize:20,marginLeft:685,marginBottom:30}}>Ürün Özellikleri</Typography>   
        </Grid>
          <Grid xs={4} style={{border:"1px solid black",height:210,marginLeft:680}}>
        ...
        <Box height={35}><Typography style={{marginLeft:10,paddingTop:2,color:"rgba(0, 0, 0, 0.7)", fontSize:"18px"}}>Ağır çalışma şartlarına dayanıklı ve korumalıdır.</Typography></Box> 
            ...
            <img alt='cl3000screenshot' src={densiPC100EkranGörüntüsü} height={100} width={400} style={{marginLeft:665,marginTop:60}}></img>
      </Grid>
