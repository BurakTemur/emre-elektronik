...
function FiyatHesaplamalıTemAtaLed() {
    ...
    return (
      <>
          <Template></Template>
          <Typography style={{position:"absolute",top:610,left:680}} fontSize={30}>Ata Led</Typography>
      ...
      <img style={{marginLeft:60,marginTop:30}} src={temAtaLed} alt={"cl3000"}height={400} width={450}></img>
