...
function VincKantarlari() {
  ...
  return (
    <>
     <Template></Template>
    <Typography style={{position:"absolute",top:610,left:680}} fontSize={30}>Vinç Kantarları</Typography>
    ...
    <Grid xs={1.5} style={{marginLeft:400,marginTop:100}}>
      ...
      <Grid onClick={()=>navigate("/Vinç Baskülü Cas")} onMouseEnter={()=> setHovered1(true)} onMouseLeave={()=>setHovered1(false)} bgcolor={"white"} container justifyContent={"center"}  xs={2} style={{height:400,marginTop:hovered1 ? 60:80,marginLeft:30,padding:30,position:"relative",border:"1px solid white", borderRadius:10,boxShadow: "2px 2px 10px rgba(0, 0, 0,0.3)", transition: "margin-top 0.5s ease"}}>
        <img src={ie1700} alt={"ie1700"}height={300} width={250}></img>
      ...
      <Grid  onClick={()=>navigate("/Vinç Baskülü Tem")} onMouseEnter={()=>setHovered2(true)} onMouseLeave={()=>setHovered2(false)} bgcolor={"white"} container justifyContent={"center"}  xs={2} style={{height:400,marginLeft:50,marginTop:hovered2 ? 60:80,padding:30,position:"relative",border:"1px solid white", borderRadius:10,boxShadow: "2px 2px 10px rgba(0, 0, 0,0.3)",transition: "margin-top 0.5s ease"}} >
        <img src={temSHWD} alt={"castonIIPlus"} height={300} width={250}></img>
        <Typography style={{fontSize:20,fontWeight:'bold',textAlign:"center"}}>TEM</Typography>
      </Grid> 
      <Grid  onClick={()=>navigate("/Vinç Baskülü Murbay")} onMouseEnter={()=>setHovered3(true)} onMouseLeave={()=>setHovered3(false)} bgcolor={"white"} container justifyContent={"center"}  xs={2} style={{height:400,marginLeft:50,marginTop:hovered3 ? 60:80,padding:30,position:"relative",border:"1px solid white", borderRadius:10,boxShadow: "2px 2px 10px rgba(0, 0, 0,0.3)",transition: "margin-top 0.5s ease"}} >
        <img src={murbaySelesOCSS1} alt={"castonIIIPlus"} height={300} width={250}></img>
