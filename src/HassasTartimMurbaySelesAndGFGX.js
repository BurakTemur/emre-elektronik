...
function HassasTartimMurbaySelesAndGFGX() {
    ...
    return (    
      <>
          <Template></Template>
          <Typography style={{position:"absolute",top:610,left:680}} fontSize={30}>Seles And GF-GX</Typography>
      ...
      <Grid xs={1.5} style={{marginLeft:400,marginTop:100}}>
         ...
         <Grid xs={4} style={{marginTop:120,marginLeft:40}}>
          ...
          <img style={{marginLeft:60,marginTop:30}} src={murbaySelesAndGFGX} alt={"cl3000"}height={400} width={450}></img>
