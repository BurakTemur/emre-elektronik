...
import MavinNa1EkranGörüntüsü from './Images/Mavin NA1 Ekran Görüntüsü.png'

function LoadcellDensiMavinNA1() {
  ...
  return (
    <>
     <Template></Template>
     <Typography style={{position:"absolute",top:610,left:"36%"}} sx={{"&:hover":{color:"black"} , fontSize: "clamp(20px, 2.51vw, 30px)", whiteSpace:"nowrap"}}>Mavin NA1</Typography>
    ...
    <Grid sx={{marginLeft:"2%",marginTop:15}}>
            ...
            <Grid container alignItems="end" marginTop={2}>
                ...
                <Typography sx={{marginLeft:"10px"}} fontSize={"16px"}>3 - 6 - 10 - 20 - 30 - 35 - 40 - 45</Typography>
            </Grid>
            ...
            <img src={MavinNa1EkranGörüntüsü} height={400} alt={"Mavin NA1"} width={"100%"}></img>
...
export default LoadcellDensiMavinNA1