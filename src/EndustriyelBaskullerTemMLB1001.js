...
function EndustriyelBaskullerTemMLB1001() {
    ...
    return (
      <>
          <Template></Template>
          <Typography style={{position:"absolute",top:610,left:680}} fontSize={30}>MLB 1001</Typography>
      ...
      <Grid xs={1.5} style={{marginLeft:400,marginTop:100}}>
         ...
         <Grid xs={4} style={{marginTop:120,marginLeft:40}}>
          ...
          <img style={{marginLeft:60,marginTop:30}} src={endustriyelBaskullerTemMLB1001} alt={"cl3000"}height={300} width={350}></img>
      </Grid>
