...
import MavinNa20EkranGörüntüsü from './Images/Mavin NA20 Ekran Görüntüsü.png'

function LoadcellDensiMavinNA20() {
  ...
  return (
    <>
     <Template></Template>
     <Typography style={{position:"absolute",top:610,left:"36%"}} sx={{"&:hover":{color:"black"} , fontSize: "clamp(20px, 2.51vw, 30px)", whiteSpace:"nowrap"}}>Mavin NA20</Typography>
    ...
    <Grid sx={{marginLeft:"2%",marginTop:15}}>
            ...
            <Grid container alignItems="end" marginTop={2}>
                ...
                <Typography sx={{marginLeft:"10px"}} fontSize={"16px"}>5 - 10 - 20 - 50 - 100 - 200 - 500</Typography>
            </Grid>
            ...
            <img src={MavinNa20EkranGörüntüsü} height={400} alt={"Mavin NA1"} width={"100%"}></img>
...
export default LoadcellDensiMavinNA20