...
function HassasTartim() {
  ...
  return (
    <>
    <Template></Template>
    <Typography style={{position:"absolute",top:610,left:680}} fontSize={30}>Hassas Tartim</Typography>
