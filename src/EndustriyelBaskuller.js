...
function EndustriyelBaskuller() {
  ...
  return (
    <>
    <Template></Template>
    <Typography style={{position:"absolute",top:610,left:"36%"}} sx={{"&:hover":{color:"black"} , fontSize: "clamp(20px, 1.51vw, 30px)", whiteSpace:"nowrap"}}>Endüstriyel Basküller</Typography>
...
export default EndustriyelBaskuller