    ...
    <>
      ...
      <Grid container>
        ...
        <Grid item style={{marginLeft:100}} xs={12} sm={6} md={4} lg={3} onClick={() => { navigate("/Teraziler") }}>
          <Box style={{ height: "150px", width: "550px" , display: 'flex', alignItems:"center"}} border={"1px solid black"} sx={{"&:hover" : {border: "1px solid #0d6efd ", transitionDelay:"0.1s"}}} onMouseEnter={handleMouseEnter(setIsHovered)} onMouseLeave={handleMouseLeave(setIsHovered)}>
            <img src={teraziler} style={{ height: 150, width: 150 }} alt="Etiketler" />
        ...
        <Grid  item style={{marginLeft:100}} xs={12} sm={6} md={4} lg={3} onClick={() => { navigate("/Etiketler") }}>
          <Box style={{height: "150px", width: "550px" , display: 'flex', alignItems:"center"}} border={"1px solid black"} sx={{"&:hover" : {border: "1px solid #0d6efd ", transitionDelay:"0.1s"}}} onMouseEnter={handleMouseEnter(setIsHovered2)} onMouseLeave={handleMouseLeave(setIsHovered2)}>
            <img src={etiketler} style={{ height: 150, width: 150 }} alt="Etiketler" />
        ...
        <Grid item style={{marginLeft:100}} xs={12} sm={6} md={4} lg={3} onClick={() => { navigate("/Streçler") }}>
          <Box style={{ height: "150px", width: "550px" , display: 'flex', alignItems:"center"}} border={"1px solid black"} sx={{"&:hover" : {border: "1px solid #0d6efd ",transitionDelay:"0.1s"}}} onMouseEnter={handleMouseEnter(setIsHovered3)} onMouseLeave={handleMouseLeave(setIsHovered3)}>
            <img src={streçler} style={{ height: 150, width: 150 }} alt="Streçler" />
