...
function TartimHanaHS1000() {
    ...
    return (
      <>
          <Template></Template>
          <Typography style={{position:"absolute",top:610,left:680}} fontSize={30}>HS-1000</Typography>
      ...
      <img style={{marginLeft:60,marginTop:30}} src={hanaHS1000LCD} alt={"cl3000"}height={400} width={450}></img>
      </Grid>
